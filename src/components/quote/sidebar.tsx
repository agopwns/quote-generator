...
export function Sidebar({ onSave }: SidebarProps) {
  ...
  return (
    <div className="w-64 border-r bg-muted flex flex-col h-full">
      ...
      {activeTab === 'quotes' ? (
        <>
          <div className="p-4 border-b">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground">{t('sidebar.autoSaved')}</p>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col min-h-0 pt-4">
          <div className="px-4 pb-2">
            <p className="text-sm text-muted-foreground">{t('sidebar.selectTemplate')}</p>
          </div>
          <TemplateSelector />
        </div>
      )}
